...
public class ContractorResourceIntTest {
    ...
    public void initTest() {
        ...
        contractor.setAddress(DEFAULT_ADDRESS);
    }
    ...
    public void createContractor() throws Exception {
        ...
        assertThat(testContractor.getAddress()).isEqualTo(DEFAULT_ADDRESS);
    }
    ...
    public void updateContractor() throws Exception {
        ...
        contractor.setAddress(UPDATED_ADDRESS);
        ...
        assertThat(testContractor.getAddress()).isEqualTo(UPDATED_ADDRESS);
    }
